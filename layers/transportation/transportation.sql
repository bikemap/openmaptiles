...
FROM (
         ...
         SELECT osm_id,
                ...
                cycle_network,
                z_order
         FROM osm_highway_linestring_gen_z9_view
         WHERE zoom_level = 9
         ...
         SELECT osm_id,
                ...
                cycle_network,
                z_order
         FROM osm_highway_linestring_gen_z10_view
         WHERE zoom_level = 10
           AND ST_Length(geometry) > ZRes(11)
         UNION ALL
         ...
         SELECT osm_id,
                ...
                cycle_network,
                z_order
         FROM osm_highway_linestring_gen_z11_view
         WHERE zoom_level = 11
         ...
         WHERE NOT is_area
           AND (
                     zoom_level = 12 AND (
                         ...
                         OR highway = 'construction' AND construction = 'cycleway'
                         OR cycle_network IS NOT NULL
                     ) AND man_made <> 'pier'
                 OR zoom_level = 13
                         AND (
                            ...
                            OR
                                    highway = 'cycleway'
                            OR
                                    highway = 'construction' AND construction = 'cycleway'
                            OR
                                    bicycle = 'yes'
                            OR
                                    cycle_network IS NOT NULL
                        )
                 OR zoom_level >= 14
                         AND (
                            man_made <> 'pier'
