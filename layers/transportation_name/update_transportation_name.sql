...
BEGIN
    ...
    WHERE EXISTS(SELECT NULL FROM transportation_name.network_changes c WHERE hl.osm_id = c.osm_id)
	...
	WHERE EXISTS(
	        SELECT NULL FROM transportation_name.network_changes AS c WHERE c.osm_id = hl.osm_id
	    ) AND (
