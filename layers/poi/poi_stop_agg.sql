-- Indexes for queries originating from osm_poi_stop_centroid materialized view
CREATE INDEX IF NOT EXISTS osm_poi_point_subclass_idx ON osm_poi_point (subclass);
...
-- Indexes for queries originating from osm_poi_stop_rank materialized view
CREATE INDEX IF NOT EXISTS osm_poi_stop_centroid_uic_ref_idx ON osm_poi_stop_centroid (uic_ref);
